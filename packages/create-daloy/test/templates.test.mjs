...
test("deno-basic template ships a runtime-native scaffold", async () => {
  ...
  assert.equal(denoJson.imports["@daloyjs/core"], "jsr:@daloyjs/daloy@^1.0.0-beta.0");
  assert.equal(
    denoJson.imports["@daloyjs/core/deno"],
    "jsr:@daloyjs/daloy@^1.0.0-beta.0/deno",
  );
  assert.equal(
    denoJson.imports["@daloyjs/core/banner"],
    "jsr:@daloyjs/daloy@^1.0.0-beta.0/banner",
  );
  assert.equal(
    denoJson.imports["@daloyjs/core/openapi"],
    "jsr:@daloyjs/daloy@^1.0.0-beta.0/openapi",
  );
});
