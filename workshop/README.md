...
This workshop tracks the current published release train: `create-daloy@1.0.0-beta.0` scaffolds templates with `@daloyjs/core@^1.0.0-beta.0`, and this workshop uses that same npm range so the exercises match the latest generated projects.
...
| Command                 | Purpose                                                              |
| ----------------------- | -------------------------------------------------------------------- |
| `pnpm install`          | Install dependencies (`@daloyjs/core@^1.0.0-beta.0`, `zod`, `tsx`)    |
