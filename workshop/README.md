...
This workshop tracks the current published release train: `create-daloy@0.37.0` scaffolds templates with `@daloyjs/core@^0.37.0`, and this workshop uses that same npm range so the exercises match the latest generated projects.
...
| Command                 | Purpose                                                              |
| ----------------------- | -------------------------------------------------------------------- |
| `pnpm install`          | Install dependencies (`@daloyjs/core@^0.37.0`, `zod`, `tsx`)          |
