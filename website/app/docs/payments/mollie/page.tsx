  ...
  return (
    <>
      ...
      <p>
        ...
        is the dominant European payment platform, strong on iDEAL, Bancontact,
        SEPA, Klarna, and a deep catalogue of local methods alongside cards and
        wallets. This guide uses the official{" "}
        <a
...
declare module "@daloyjs/core" {
  interface AppState {
    mollie: MollieClient;
      ...
      />
      <p>
        <code>SignatureValidator</code> uses HMAC-SHA256 over the raw request
        body. The <em>raw</em> body is non-negotiable, re-serialising parsed
  ...
  throw e;
      ...
      <ul>
        <li>
          ...
          <code>@mollie/api-client</code> is fine for legacy code but no longer
