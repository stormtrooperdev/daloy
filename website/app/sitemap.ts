...
const STATIC_PATHS: Array<{
  ...
  {
    path: "/blog/best-node-express-alternative-daloyjs",
    changeFrequency: "monthly",
    priority: 0.7,
  },
  {
  ...
  { path: "/docs/config", changeFrequency: "monthly", priority: 0.7 },
  ...
  { path: "/docs/response-cache", changeFrequency: "monthly", priority: 0.8 },
  { path: "/docs/pagination", changeFrequency: "monthly", priority: 0.8 },
  { path: "/docs/multitenancy", changeFrequency: "monthly", priority: 0.8 },
