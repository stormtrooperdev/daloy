...
export const docsNav: DocsNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Lifecycle leftovers", href: "/docs/security/wave-4-leftovers" },
      { title: "Auth slice", href: "/docs/security/wave-5-auth" },
      { title: "WebSocket + login throttle", href: "/docs/security/wave-5-remaining" },
