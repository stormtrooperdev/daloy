...
export const docsNav: DocsNavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Lifecycle leftovers (0.20.0)", href: "/docs/security/wave-4-leftovers" },
      { title: "Auth slice (0.22.0)", href: "/docs/security/wave-5-auth" },
      { title: "WebSocket + login throttle (0.23.0)", href: "/docs/security/wave-5-remaining" },
